    ...
    return (
        <>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 min-h-screen'>
                <div className='flex flex-col justify-center w-full lg:w-10/12 mx-auto space-y-2 p-2'>
                    <h1 className='text-2xl md:text-5xl font-bold'>Connect, Collaborate, Conquer: Your Ultimate Contact Management Solution!</h1>
